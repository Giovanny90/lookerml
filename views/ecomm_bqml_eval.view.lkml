...
view: ecomm_model_eval {
  derived_table: {
    sql: SELECT * FROM (
            SELECT 4 as clusters_num,* FROM ML.EVALUATE(MODEL `interno-davinci-analitica.thelook_ecommerce.kmeans_model4`, (SELECT * except(user_id) FROM ${ecomm_feature_generation.SQL_TABLE_NAME})) UNION ALL
            SELECT 5 as clusters_num,* FROM ML.EVALUATE(MODEL `interno-davinci-analitica.thelook_ecommerce.kmeans_model5`, (SELECT * except(user_id) FROM ${ecomm_feature_generation.SQL_TABLE_NAME})) UNION ALL
            SELECT 6 as clusters_num,* FROM ML.EVALUATE(MODEL `interno-davinci-analitica.thelook_ecommerce.kmeans_model6`, (SELECT * except(user_id) FROM ${ecomm_feature_generation.SQL_TABLE_NAME})) UNION ALL
            SELECT 7 as clusters_num,* FROM ML.EVALUATE(MODEL `interno-davinci-analitica.thelook_ecommerce.kmeans_model7`, (SELECT * except(user_id) FROM ${ecomm_feature_generation.SQL_TABLE_NAME})) UNION ALL
            SELECT 8 as clusters_num,* FROM ML.EVALUATE(MODEL `interno-davinci-analitica.thelook_ecommerce.kmeans_model8`, (SELECT * except(user_id) FROM ${ecomm_feature_generation.SQL_TABLE_NAME})) UNION ALL
            SELECT 10 as clusters_num,* FROM ML.EVALUATE(MODEL `interno-davinci-analitica.thelook_ecommerce.kmeans_model10`,(SELECT * except(user_id) FROM ${ecomm_feature_generation.SQL_TABLE_NAME})) UNION ALL
            SELECT 12 as clusters_num,* FROM ML.EVALUATE(MODEL `interno-davinci-analitica.thelook_ecommerce.kmeans_model12`,(SELECT * except(user_id) FROM ${ecomm_feature_generation.SQL_TABLE_NAME}))) ;;
  }
...
view: ecomm_training_info {
  derived_table: {
    sql:  SELECT 4 as clusters_num, * FROM ML.TRAINING_INFO(MODEL `interno-davinci-analitica.thelook_ecommerce.kmeans_model4`) UNION ALL
          SELECT 5 as clusters_num, * FROM ML.TRAINING_INFO(MODEL `interno-davinci-analitica.thelook_ecommerce.kmeans_model5`) UNION ALL
          SELECT 6 as clusters_num, * FROM ML.TRAINING_INFO(MODEL `interno-davinci-analitica.thelook_ecommerce.kmeans_model6`) UNION ALL
          SELECT 7 as clusters_num, * FROM ML.TRAINING_INFO(MODEL `interno-davinci-analitica.thelook_ecommerce.kmeans_model7`) UNION ALL
          SELECT 8 as clusters_num, * FROM ML.TRAINING_INFO(MODEL `interno-davinci-analitica.thelook_ecommerce.kmeans_model8`) UNION ALL
          SELECT 10 as clusters_num, * FROM ML.TRAINING_INFO(MODEL `interno-davinci-analitica.thelook_ecommerce.kmeans_model10`) UNION ALL
          SELECT 12 as clusters_num, * FROM ML.TRAINING_INFO(MODEL `interno-davinci-analitica.thelook_ecommerce.kmeans_model12`);;
  }
