...
view: user_order_product {
  derived_table: {
    ...
    sql: SELECT
      ...
      FROM interno-davinci-analitica.thelook_ecommerce.order_items oi
      LEFT JOIN interno-davinci-analitica.thelook_ecommerce.inventory_items ii
        ON oi.inventory_item_id = ii.id
      LEFT JOIN interno-davinci-analitica.thelook_ecommerce.products p
...
view: total_order_product {
  derived_table: {
    ...
    sql: SELECT
        ...
        , COUNT(*) AS prod_freq
      FROM interno-davinci-analitica.thelook_ecommerce.order_items oi
      LEFT JOIN interno-davinci-analitica.thelook_ecommerce.inventory_items
