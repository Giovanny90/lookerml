view: trailing_sales_snapshot {
  derived_table: {
    ...
    sql: with calendar as
      ...
      from interno-davinci-analitica.thelook_ecommerce.inventory_items
      ...
      from interno-davinci-analitica.thelook_ecommerce.order_items
      join interno-davinci-analitica.thelook_ecommerce.inventory_items
