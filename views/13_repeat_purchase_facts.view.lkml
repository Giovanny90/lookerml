view: repeat_purchase_facts {
  ...
  derived_table: {
    ...
    FROM interno-davinci-analitica.thelook_ecommerce.order_items as order_items
    LEFT JOIN interno-davinci-analitica.thelook_ecommerce.order_items repeat_order_items
